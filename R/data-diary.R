...
business_keywords <- c("agriculture in the united kingdom", "annual population survey", "apprenticeship", "balance sheet", "bank rate", "benefit sanctions", "budget allocation", "business", "capital acquisitons", "claimant count", "construction output", "consumer price", "cost of living", "CPI(H)", "credit union", "domestic rates", "earnings and employment", "earnings and expenses", "economic activity", "economic estimates", "economic statistics", "economic well-being", "electric vehicle", "electricity consumption", "employer skills survey", "employment cost index", "employment situation", "energy consumption in the UK", "energy performance of building certificates", "family food", "fiscal risk", "fuel prices", "foreign direct investment", "fuel sales", "gdp", "government debt", "gross domestic", "HICP", "house building", "house price", "household energy efficiency", "household income", "housing benefit", "housing purchase affordability", "housing survey", "HMRC survey compliance cost", "import and export", "income from farming", "index of production", "index of services", "industrial turnover", "interest rate", "international reserves", "insolvency", "job openings", "job seekers", "labour", "labor", "market data", "mergers and acquisitions", "money and credit", "national accounts", "price index", "producer price", "productivity", "profitability", "public sector finances", "rail fares", "rail passenger numbers", "rail performance", "real earnings", "rental prices", "retail sales", "revenues and expenses", "revenues and spend", "stamp duty", "taxpayers", "tax credit", "tax receipt", "tax relief", "time use", "trade", "trends and prices", "uk economic accounts", "uk energy in brief", "uk energy statistics", "universal credit", "unemployment", "vehicle licensing statistics", "weekly earnings", "working and workless", "world economic outlook") |>
  paste(collapse = "|")
